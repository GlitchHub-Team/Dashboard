...
export class UserApiClientMockService {
  private mockUsers: User[] = [
    ...
    {
      id: 'user-4160',
      email: 'alice.smith@tenant-a.com',
      role: UserRole.TENANT_USER,
      tenantId: 'tenant-a',
    },
    {
      id: 'user-5386',
      email: 'bob.jones@tenant-a.com',
      role: UserRole.TENANT_USER,
      tenantId: 'tenant-a',
    },
    {
      id: 'user-6397',
      email: 'charlie.brown@tenant-b.com',
      role: UserRole.TENANT_ADMIN,
      tenantId: 'tenant-b',
    },
    {
      id: 'user-7351',
      email: 'diana.prince@tenant-b.com',
      role: UserRole.TENANT_USER,
      tenantId: 'tenant-b',
    },
    {
      id: 'user-8888',
      email: 'eve.davis@tenant-c.com',
      role: UserRole.TENANT_ADMIN,
      tenantId: 'tenant-c',
    },
    {
      id: 'user-9765',
      email: 'frank.miller@tenant-c.com',
      role: UserRole.TENANT_USER,
      tenantId: 'tenant-c',
    },
    {
      id: 'user-1027',
      email: 'grace.hopper@tenant-c.com',
      role: UserRole.TENANT_USER,
      tenantId: 'tenant-c',
    },
    {
      id: 'user-1136',
      email: 'heidi.klum@tenant-a.com',
      role: UserRole.TENANT_ADMIN,
      tenantId: 'tenant-a',
    },
    {
      id: 'user-1283',
      email: 'ivan.drago@tenant-b.com',
      role: UserRole.TENANT_USER,
      tenantId: 'tenant-b',
    },
    {
      id: 'user-1390',
      email: 'judy.garland@tenant-c.com',
      role: UserRole.TENANT_USER,
      tenantId: 'tenant-c',
    },
    {
      id: 'user-1482',
      email: 'kevin.bacon@tenant-a.com',
      role: UserRole.TENANT_USER,
      tenantId: 'tenant-a',
    },
    {
      id: 'user-1516',
      email: 'laura.croft@tenant-b.com',
      role: UserRole.TENANT_ADMIN,
      tenantId: 'tenant-b',
    },
  ];
