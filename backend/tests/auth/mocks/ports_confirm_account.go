...
//
//	mockgen -destination=../../tests/auth/mocks/ports_confirm_account.go -package=mocks . ConfirmAccountTokenPort
//
...
func (m *MockConfirmAccountTokenPort) GetTenantConfirmAccountToken(tenantId uuid.UUID, tokenString string) (auth.ConfirmAccountToken, error) {
	m.ctrl.T.Helper()
