...
func TestController_GetSensorHistoricalData(t *testing.T) {
	...
	cases := []genericControllerTestCase[mocks.MockGetSensorHistoricalDataUseCase]{
		...
		},
		{
			...
			method:           http.MethodGet,
			url:              baseURL + "?from_time=2026-03-29T12:00:00Z&to_time=2026-03-29T13:00:00Z&max_data_points=10",
			requester:        requester,
			setupSteps:       []mockUseCaseSetupFunc[mocks.MockGetSensorHistoricalDataUseCase]{useCaseOK},
			expectedStatus:   http.StatusOK,
			expectedResponse: expectedResponse,
		...
		},
		{
			...
			method:           http.MethodGet,
			url:              baseURL + "?from_time=not-a-date",
			requester:        requester,
			setupSteps:       []mockUseCaseSetupFunc[mocks.MockGetSensorHistoricalDataUseCase]{useCaseNeverCalled},
			expectedStatus:   http.StatusBadRequest,
			expectedResponse: hasError{},
		...
		{
			name:             "Fail: only from_time provided",
			method:           http.MethodGet,
			url:              baseURL + "?from_time=2026-03-29T12:00:00Z",
			requester:        requester,
			setupSteps:       []mockUseCaseSetupFunc[mocks.MockGetSensorHistoricalDataUseCase]{useCaseNeverCalled},
			expectedStatus:   http.StatusBadRequest,
			expectedResponse: hasError{},
		...
		{
			name:             "Fail: only to_time provided",
			method:           http.MethodGet,
			url:              baseURL + "?to_time=2026-03-29T13:00:00Z",
			requester:        requester,
			setupSteps:       []mockUseCaseSetupFunc[mocks.MockGetSensorHistoricalDataUseCase]{useCaseNeverCalled},
			expectedStatus:   http.StatusBadRequest,
			expectedResponse: hasError{},
