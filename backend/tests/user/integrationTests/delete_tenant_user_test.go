...
func TestDeleteTenantUserIntegration(t *testing.T) {
	...
	tcSuccess = helper.IntegrationTestCase{
		PreSetups: []helper.IntegrationTestPreSetup{
			...
			PreSetupAddTenantUser(t, &tcSuccess, existingTenantAdmin1Entity, true),
			PreSetupAddTenantUser(t, &tcSuccess, existingTenantAdmin2Entity, true),
		},
	...
	tcNoJwt = helper.IntegrationTestCase{
		PreSetups: []helper.IntegrationTestPreSetup{
			preSetupCreateTenant(tenant1Id, true),
			PreSetupAddTenantUser(t, &tcNoJwt, existingTenantAdmin1Entity, true),
		},
	...
	tests = append(tests, &helper.IntegrationTestCase{
		PreSetups: []helper.IntegrationTestPreSetup{
			preSetupCreateTenant(tenant1Id, true),
			PreSetupAddTenantUser(t, nil, existingTenantAdmin1Entity, false),
		},
	...
	tcTenantNotFound = helper.IntegrationTestCase{
		PreSetups: []helper.IntegrationTestPreSetup{
			preSetupCreateTenant(tenant1Id, true),
			PreSetupAddTenantUser(t, &tcTenantNotFound, existingTenantAdmin1Entity, false),
		},
	...
	tcTenantUser = helper.IntegrationTestCase{
		PreSetups: []helper.IntegrationTestPreSetup{
			preSetupCreateTenant(tenant1Id, true),
			PreSetupAddTenantUser(t, &tcTenantUser, existingTenantAdmin1Entity, true),
		},
	...
	tcWrongTenantId = helper.IntegrationTestCase{
		PreSetups: []helper.IntegrationTestPreSetup{
			preSetupCreateTenant(tenant1Id, true),
			PreSetupAddTenantUser(t, &tcWrongTenantId, existingTenantAdmin1Entity, true),
		},
		Name:   "Fail: unauthorized role (tenant user) cannot delete",
		Method: http.MethodDelete,
	...
	tcSuperAdmin_NoImpersonate = helper.IntegrationTestCase{
		PreSetups: []helper.IntegrationTestPreSetup{
			...
			PreSetupAddTenantUser(t, &tcSuperAdmin_NoImpersonate, existingTenantAdmin1Entity, true),
			PreSetupAddTenantUser(t, &tcSuperAdmin_NoImpersonate, existingTenantAdmin2Entity, true),
		},
