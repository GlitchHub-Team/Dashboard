...
func TestGetTenantAdminsIntegration(t *testing.T) {
	...
	tests = append(tests, &helper.IntegrationTestCase{
		PreSetups: []helper.IntegrationTestPreSetup{
			...
			PreSetupAddTenantAdmin(t, nil, tenantAdmin1Entity, false),
			PreSetupAddTenantAdmin(t, nil, tenantAdmin2Entity, false),
		},
